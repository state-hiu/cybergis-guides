...
Before you begin the installation process, you'll need to provision a virtual or physical machine.  ROGUE GeoNode will run on Amazon Web Services (AWS), Vagrant, and almost any type of virtual machine.
