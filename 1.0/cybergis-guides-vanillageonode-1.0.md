...
This guide provides instructions for installing and managing a vanilla GeoNode instance in a production environment.  You can find information about installing a vanilla GeoNode without the advanced data editing and sharing technology at [http://geonode.org/](http://geonode.org/).  You can find more information about ROGUE below and at [http://rogue.lmnsolutions.com/](http://rogue.lmnsolutions.com/).  Use the directions found at [http://rogue.lmnsolutions.com/](http://rogue.lmnsolutions.com/) for deploying a ROGUE GeoNode in a development environment.
